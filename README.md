...
**[Download the Windows installer](https://github.com/lykaiosx/AMF/releases/tag/v4.20)**

Run **AMF-4.20-Setup.exe**. It includes Python, Qt/PySide6 and all required Python
...
`dist\AMF-4.20-Setup.exe` and `Setup.exe`. Runtime and installer binaries are excluded
